...
/**
 * 수주생성 조회 및 저장  (ZWEB_SD_CREAT_SO) WebServiceStub
 * @Comment 
 *     	- Sso0060C(수주생성) 에서 사용
 *     
 * @since 1.0 
...
public class ZWEB_SD_CREAT_SO_N extends WebServiceStub {

	public ZWEB_SD_CREAT_SO_N() throws AxisFault {
		super();
	}
	...
	protected void initOperation(Object obj) { 
		...
		oper.addParameter(makeArrayParam("O_ETAB" 	, PARAM_INOUT, "TABLE_OF_ZPSSEMSG", ZQMSEMSG[].class, "item"));		// ERROR
