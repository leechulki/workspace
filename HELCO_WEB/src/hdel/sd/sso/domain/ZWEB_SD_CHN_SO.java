...
public class ZWEB_SD_CHN_SO extends WebServiceStub {

	public ZWEB_SD_CHN_SO() throws AxisFault {
		super();
	}
	...
	protected Object[][] getCustTypes() {
    	...
    	obj[6] = new Object[]{"ZSDT0091", ZSDT0091.class};
    	obj[7] = new Object[]{"TABLE_OF_ZSDT0091", "ZSDT0091", "item", ZSDT0091[].class };

    	obj[8] = new Object[]{"ZSDT0094", ZSDT0094.class};
    	obj[9] = new Object[]{"TABLE_OF_ZSDT0094", "ZSDT0094", "item", ZSDT0094[].class };

    	obj[10] = new Object[]{"ZSDT0094", ZSDT0094.class};
    	obj[11] = new Object[]{"TABLE_OF_ZSDT0094", "ZSDT0094", "item", ZSDT0094[].class };

    	obj[12] = new Object[]{"BAPIRET2", BAPIRET2.class};
    	obj[13] = new Object[]{"TABLE_OF_BAPIRET2", "BAPIRET2", "item", BAPIRET2[].class };
