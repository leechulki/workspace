...
import hdel.sd.sso.dao.Sso0130D;
...
@Service
public class Sso0130S extends SrmService {
	Logger logger = Logger.getLogger(this.getClass());

	private Sso0130D dao;
	
	@Override
	public void createDao(SqlSession sqlSession) {
		// TODO Auto-generated method stub
		dao = sqlSession.getMapper(Sso0130D.class);
		
	}
 

	// 조회
	public List<Sso0130VO> find(Sso0130ParamVO paramV) {
		...
		else
		{
			...
			// 컬럼정보별 소계컬럼을 처리
			List<Sso0130VO> list = dao.SelectWaerk(paramV);
