...
import hdel.sd.sso.dao.Sso0190D;
...
@Service
public class Sso0190S extends SrmService {
	Logger logger = Logger.getLogger(this.getClass());

	private Sso0190D dao;
	
	@Override
	public void createDao(SqlSession sqlSession) {
		// TODO Auto-generated method stub
		dao = sqlSession.getMapper(Sso0190D.class);
		
	}
 

	// 조회
	public List<Sso0190VO> find(Sso0190ParamVO paramV) {
		...
		else
		{
			...
			// 컬럼정보별 소계컬럼을 처리
			List<Sso0190VO> list = dao.SelectWaerk(paramV);
