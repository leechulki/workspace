...
import hdel.sd.sso.service.Sso0140S;
...
@Controller
@RequestMapping("sso0140")
public class Sso0140C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sso0140ParamVO paramV = new Sso0140ParamVO();					// vo
			...
			List<Sso0140VO> list = service.find(paramV);
			 
			Dataset dsOutput = new Dataset();
			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sso0140VO.class, list );
