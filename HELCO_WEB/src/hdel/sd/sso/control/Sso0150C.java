...
import hdel.sd.sso.service.Sso0150S;
...
@Controller
@RequestMapping("sso0150")
public class Sso0150C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sso0150ParamVO paramV = new Sso0150ParamVO();					// vo
			...
			List<Sso0150VO> list = service.find(paramV);
			
			Dataset dsOutput = new Dataset();
			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sso0150VO.class, list );
