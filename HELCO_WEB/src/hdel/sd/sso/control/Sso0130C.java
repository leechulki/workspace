...
import hdel.sd.sso.service.Sso0130S;
...
@Controller
@RequestMapping("sso0130")
public class Sso0130C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sso0130ParamVO paramV = new Sso0130ParamVO();					// vo
			...
			List<Sso0130VO> list = service.find(paramV);
			
			Dataset dsOutput = new Dataset();
			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sso0130VO.class, list );
