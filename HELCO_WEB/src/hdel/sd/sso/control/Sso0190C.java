...
import hdel.sd.sso.service.Sso0190S;
...
@Controller
@RequestMapping("sso0190")
public class Sso0190C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sso0190ParamVO paramV = new Sso0190ParamVO();					// vo
			...
			List<Sso0190VO> list = service.find(paramV);
			
			Dataset dsOutput = new Dataset();
			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sso0190VO.class, list );
