...
import hdel.sd.sso.service.Sso0170S;
...
@Controller
@RequestMapping("sso0170")
public class Sso0170C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sso0170ParamVO paramV = new Sso0170ParamVO();					// vo
			...
			List<Sso0170VO> list = service.find(paramV);
			
			Dataset dsOutput = new Dataset();

			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sso0170VO.class, list );
