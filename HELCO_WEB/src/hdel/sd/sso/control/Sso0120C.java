...
import hdel.sd.sso.service.Sso0120S;
...
@Controller
@RequestMapping("sso0120")
public class Sso0120C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sso0120ParamVO paramV = new Sso0120ParamVO();					// vo
			...
			List<Sso0120VO> list = service.find(paramV);
			 
			Dataset dsOutput = new Dataset();
			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sso0120VO.class, list );
