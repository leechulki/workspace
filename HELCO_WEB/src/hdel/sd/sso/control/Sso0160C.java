...
import hdel.sd.sso.service.Sso0160S;
...
@Controller
@RequestMapping("sso0160")
public class Sso0160C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sso0160ParamVO paramV = new Sso0160ParamVO();					// vo
			...
			List<Sso0160VO> list = service.find(paramV);
			 
			Dataset dsOutput = new Dataset();
			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sso0160VO.class, list );
