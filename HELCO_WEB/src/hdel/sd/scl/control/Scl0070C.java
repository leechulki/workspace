...
import hdel.sd.scl.service.Scl0070S;
...
@Controller
@RequestMapping("scl0070")
public class Scl0070C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Scl0070ParamVO paramV = new Scl0070ParamVO();					// vo
			...
			List<Scl0070VO> list = service.find(paramV);
			
			// list결과를 dataset으로 담기
			Dataset dsOutput = new Dataset();
			SmpComC.moveDs2List(dsOutput, Scl0070VO.class, list );
