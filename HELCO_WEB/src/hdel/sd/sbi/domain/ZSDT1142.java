...
/**
 * ZSDT1142(브랜드별 특성값) Value Of Class
 * 
 * @author  박수근
 * @since 2020.08.20
 * @version 1.0
...
public class ZSDT1142 extends CommonDomain {
	...
	public String toString() {
		return "ZSDT1142 [MANDT=" + MANDT + ", BRNDSEQ=" + BRNDSEQ + ", ZPRDGBN=" + ZPRDGBN + ", BRNDCD=" + BRNDCD
				+ ", PRH=" + PRH + ", PRD=" + PRD + ", DISPTP=" + DISPTP + ", DIPSDAT=" + DIPSDAT + ", ERDAT=" + ERDAT
				+ ", ERZET=" + ERZET + ", ERNAM=" + ERNAM + ", AEDAT=" + AEDAT + ", AEZET=" + AEZET + ", AENAM=" + AENAM
				+ ", FLAG=" + FLAG + "]";
	}	
