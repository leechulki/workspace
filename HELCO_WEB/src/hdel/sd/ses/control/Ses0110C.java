...
import hdel.sd.ses.service.Ses0110S;
...
@Controller
@RequestMapping("ses0110")
public class Ses0110C {
	...
	@Autowired
	private Ses0110S service;
	
	@RequestMapping(value="header")
	public View Ses0110FindView(MipParameterVO paramVO, Model model) {

		Dataset dsCond = paramVO.getDataset("ds_cond");
		Dataset dsList	= paramVO.getDataset("ds_header");	// UI로 return할 out dataset  
		 
		try { 
			Ses0110ParamVO param = new Ses0110ParamVO();
			...
			List<Ses0110> list = service.searchHeader(param);   			// 서비스CALL
			dsList.deleteAll();
	...
	public View Ses0110DtlView(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			List<Ses0110> list = service.searchDetail(param);  	// 서비스CALL
			dsList.deleteAll();
	...
	public View Ses0110ReceiptView(MipParameterVO paramVO, Model model) { 
	...
	public View Ses0110ReceiptCancelView(MipParameterVO paramVO, Model model) { 
