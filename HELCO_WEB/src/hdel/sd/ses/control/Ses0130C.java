...
import hdel.sd.ses.service.Ses0130S;
...
@Controller
@RequestMapping("ses0130")
public class Ses0130C {
	...
	@Autowired
	private Ses0130S service;
	
	@RequestMapping(value="header")
	public View Ses0130FindView(MipParameterVO paramVO, Model model) {

		Dataset dsCond = paramVO.getDataset("ds_cond");
		Dataset dsList	= paramVO.getDataset("ds_header");	// UI로 return할 out dataset  
		 
		try { 
			Ses0130ParamVO param = new Ses0130ParamVO();
			...
			List<Ses0130> list = service.searchHeader(param);   			// 서비스CALL
			dsList.deleteAll();
	...
	public View Ses0130DtlView(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			List<Ses0130> list = service.searchDetail(param);  	// 서비스CALL
			dsList.deleteAll();
	...
	public View Ses0130approvalView(MipParameterVO paramVO, Model model) { 
	...
	public View Ses0130rejectView(MipParameterVO paramVO, Model model) { 
