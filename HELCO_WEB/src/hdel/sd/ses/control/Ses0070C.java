...
import hdel.sd.ses.service.Ses0070S;
...
@Controller
@RequestMapping("ses0070")
public class Ses0070C {
	...
	@Autowired
	private Ses0070S service;
	
	@RequestMapping(value="header")
	public View Ses0070FindView(MipParameterVO paramVO, Model model) {

		Dataset dsCond = paramVO.getDataset("ds_cond");
		Dataset dsList = paramVO.getDataset("ds_header");	// UI로 return할 out dataset  
		 
		try { 
			Ses0070ParamVO param = new Ses0070ParamVO();
			...
			List<Ses0070> list = service.searchHeader(param);   			// 서비스CALL
			dsList.deleteAll();
...
//			System.out.println("============== ds_header.getRowCount() " + dsList.getRowCount());
	...
	public View Ses0070DtlView(MipParameterVO paramVO, Model model) {
...
//			System.out.print("\n@@@ dsCond.QTSER	     ===>"+DatasetUtility.getString(dsCond,"QTSER")	+"\n");
			...
			List<Ses0070> list = service.searchDetail(param);  	// 서비스CALL
			dsList.deleteAll();
...
//			System.out.println("============== ds_detail.getRowCount() " + dsList.getRowCount());
	...
	public View Ses0070ReceiptView(MipParameterVO paramVO, Model model) { 
...
//		System.out.print("\n@@@ ds_error.getRowCount  ===>"+ds_error.getRowCount() 	+ "\n");
	...
	public View Ses0070ReceiptCancelView(MipParameterVO paramVO, Model model) { 
