...
import hdel.sd.ses.service.Ses0036S;
...
@Controller
@RequestMapping("ses0036")
public class Ses0036C {
	...
	@Autowired
	private Ses0036S service;
	
	/*------------------------------------------------------------
	 *  기술검토결과등록
	 ------------------------------------------------------------*/
	@RequestMapping(value="save")
	public View Ses0036SaveView(MipParameterVO paramVO, Model model) { 
