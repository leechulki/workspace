...
import hdel.sd.ses.service.Ses0100S;
...
@Controller
@RequestMapping("ses0100")
public class Ses0100C {
	...
	@Autowired
	private Ses0100S service;
	
	@RequestMapping(value="header")
	public View Ses0100FindView(MipParameterVO paramVO, Model model) {

		Dataset dsCond = paramVO.getDataset("ds_cond");
		Dataset dsList	= paramVO.getDataset("ds_header");	// UI로 return할 out dataset  
		 
		try { 
			Ses0100ParamVO param = new Ses0100ParamVO();
...
//			System.out.print("\n@@@ dsCond.SMAN         ===>"+DatasetUtility.getString(dsCond,"SMAN")	    +"\n");
			...
			List<Ses0100> list = service.searchHeader(param);   			// 서비스CALL
			dsList.deleteAll();
...
//			System.out.println("============== ds_header.getRowCount() " + dsList.getRowCount());
	...
	public View Ses0100DtlView(MipParameterVO paramVO, Model model) {
...
//			System.out.print("\n@@@ dsCond.QTSER	     ===>"+DatasetUtility.getString(dsCond,"QTSER")	+"\n");
			...
			List<Ses0100> list = service.searchDetail(param);  	// 서비스CALL
			dsList.deleteAll();
...
//			System.out.println("============== ds_detail.getRowCount() " + dsList.getRowCount());
	...
	public View Ses0100approvalView(MipParameterVO paramVO, Model model) { 
...
//		System.out.print("\n@@@ ds_error.getRowCount  ===>"+ds_error.getRowCount() 	+ "\n");
	...
	public View Ses0100rejectView(MipParameterVO paramVO, Model model) { 
