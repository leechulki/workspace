...
import hdel.sd.ses.service.Ses0170S;
...
@Controller
@RequestMapping("ses0170")
public class Ses0170C {
	...
	@Autowired
	private Ses0170S service;
	
	@RequestMapping(value="header")
	public View Ses0170FindView(MipParameterVO paramVO, Model model) {

		Dataset dsCond = paramVO.getDataset("ds_cond");
		Dataset dsList	= paramVO.getDataset("ds_header");	// UI로 return할 out dataset  
		 
		try { 
			Ses0170ParamVO param = new Ses0170ParamVO();
...
//			System.out.print("\n@@@ dsCond.SPART         ===>"+DatasetUtility.getString(dsCond,"SPART")	    +"\n");
			...
			List<Ses0170> list = service.searchHeader(param);   			// 서비스CALL
			dsList.deleteAll();
