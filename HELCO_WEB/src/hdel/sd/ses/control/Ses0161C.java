...
import hdel.sd.ses.service.Ses0161S;
...
@Controller
@RequestMapping("ses0161")
public class Ses0161C {
	...
	@Autowired
	private Ses0161S service;
	
	/*------------------------------------------------------------
	 *  기술검토결과등록
	 ------------------------------------------------------------*/
	@RequestMapping(value="save")
	public View Ses0161SaveView(MipParameterVO paramVO, Model model) { 
