...
import hdel.sd.ses.service.Ses0160S;
...
@Controller
@RequestMapping("ses0160")
public class Ses0160C {
	...
	@Autowired
	private Ses0160S service;
	
	@RequestMapping(value="header")
	public View Ses0160FindView(MipParameterVO paramVO, Model model) {

		Dataset dsCond = paramVO.getDataset("ds_cond");
		Dataset dsList	= paramVO.getDataset("ds_header");	// UI로 return할 out dataset  
		 
		try { 
			Ses0160ParamVO param = new Ses0160ParamVO();
...
//			System.out.print("\n@@@ dsCond.SMAN         ===>"+DatasetUtility.getString(dsCond,"SMAN")	    +"\n");
			...
			List<Ses0160> list = service.searchHeader(param);   			// 서비스CALL
			dsList.deleteAll();
...
//			System.out.println("============== ds_header.getRowCount() " + dsList.getRowCount());
	...
	public View Ses0160DtlView(MipParameterVO paramVO, Model model) {
...
//			System.out.print("\n@@@ dsCond.QTSER	     ===>"+DatasetUtility.getString(dsCond,"QTSER")	+"\n");
			...
			List<Ses0160> list = service.searchDetail(param);  	// 서비스CALL
			dsList.deleteAll();
...
//			System.out.println("============== ds_detail.getRowCount() " + dsList.getRowCount());
	...
	public View Ses0160ReceiptView(MipParameterVO paramVO, Model model) { 
...
//		System.out.print("\n@@@ ds_error.getRowCount  ===>"+ds_error.getRowCount() 	+ "\n");
	...
	public View Ses0160ReceiptCancelView(MipParameterVO paramVO, Model model) { 
