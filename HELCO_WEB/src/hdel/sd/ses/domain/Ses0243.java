...
public class Ses0243 extends CommonDomain {
 
	private String  mandt;				//mandt
	private String  vbeln; 				//영업오더번호
	private String  zzpjt_id;				//프로젝트번호
	...
	private String  ponetwr;       //상해금액
	private String acdat;			//상해접수일자
	private String poedatu;		//상해납기일자
	...
	private String  powaerk;       //상해통화단위
	private String  kzwi5;       //원가금액
	private String  mailaddr;       //담당자이메일주소
	...
	public String getPonetwr() {
		return ponetwr;
	}
	public void setPonetwr(String ponetwr) {
		this.ponetwr = ponetwr;
	}
	...
	public String getPoedatu() {
		return poedatu;
	}
	public void setPoedatu(String poedatu) {
		this.poedatu = poedatu;
	}
	...
	public String getPowaerk() {
		return powaerk;
	}
	public void setPowaerk(String powaerk) {
		this.powaerk = powaerk;
	}
