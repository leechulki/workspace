...
import hdel.sd.sch.service.Sch0040S;
...
@Controller
@RequestMapping("sch0040")
public class Sch0040C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sch0040ParamVO paramV = new Sch0040ParamVO();					// vo
			...
			List<Sch0040VO> list = service.find(paramV);
			
			// list결과를 dataset으로 담기
			Dataset dsOutput = new Dataset();
			SmpComC.moveDs2List(dsOutput, Sch0040VO.class, list );
