...
import hdel.sd.sch.service.Sch0050S;
...
@Controller
@RequestMapping("sch0050")
public class Sch0050C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sch0050ParamVO paramV = new Sch0050ParamVO();					// vo
			...
			List<Sch0050VO> list = service.find(paramV);
			
			Dataset dsOutput = new Dataset();
			// list결과를 dataset으로 담기
			SmpComC.moveDs2List(dsOutput, Sch0050VO.class, list );
