...
import hdel.sd.smp.service.Smp0110S;
...
@Controller
@RequestMapping("smp0110")
public class Smp0110C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Smp0110ParamVO paramV = new Smp0110ParamVO();					// vo
			...
			List<Smp0110VO> list = service.find(paramV);
			
			// list결과를 dataset으로 담기
			Dataset dsOutput = new Dataset();
			SmpComC.moveDs2List(dsOutput, Smp0110VO.class, list );
