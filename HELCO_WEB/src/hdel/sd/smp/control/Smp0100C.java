...
import hdel.sd.smp.service.Smp0100S;
...
@Controller
@RequestMapping("smp0100")
public class Smp0100C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Smp0100ParamVO paramV = new Smp0100ParamVO();					// vo
			...
			List<Smp0100VO> list = service.find(paramV);
			
			// list결과를 dataset으로 담기
			Dataset dsOutput = new Dataset();
			SmpComC.moveDs2List(dsOutput, Smp0100VO.class, list );
