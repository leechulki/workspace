...
import hdel.sd.smp.service.Smp0120S;
...
@Controller
@RequestMapping("smp0120")
public class Smp0120C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Smp0120ParamVO paramV = new Smp0120ParamVO();					// vo
			...
			List<Smp0120VO> list = service.find(paramV);
			
			// list결과를 dataset으로 담기
			Dataset dsOutput = new Dataset();
			SmpComC.moveDs2List(dsOutput, Smp0120VO.class, list );
