...
public class Com0150 extends CommonDomain {
	...
	public String getAtzhl() {
		return atzhl;
	}

	public void setAtzhl(String atzhl) {
		this.atzhl = atzhl;
	}
	...
	public String getAtson() {
		return atson;
	}

	public void setAtson(String atson) {
		this.atson = atson;
	}
}
