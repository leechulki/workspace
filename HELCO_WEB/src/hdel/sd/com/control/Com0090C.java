...
import hdel.sd.com.service.Com0090S;
...
@Controller
@RequestMapping("com0090")
public class Com0090C {
	...
	@Autowired
	private Com0090S service;
	
	@RequestMapping(value="find")
	public View Com0090FindView(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Com0090ParamVO param = new Com0090ParamVO();
			...
			// 서비스CALL
			List<Com0090> list = service.find(param);  
