...
import hdel.sd.com.service.Com0080S;
...
@Controller
@RequestMapping("com0080")
public class Com0080C {
	...
	@Autowired
	private Com0080S service;
	
	@RequestMapping(value="find")
	public View Com0080FindView(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Com0080ParamVO param = new Com0080ParamVO();
			...
			// 서비스CALL
			List<Com0080> list = service.find(param);  
