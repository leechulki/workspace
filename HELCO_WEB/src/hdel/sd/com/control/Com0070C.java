...
import hdel.sd.com.service.Com0070S;
...
@Controller
@RequestMapping("com0070")
public class Com0070C {
	...
	@Autowired
	private Com0070S service;
	
	@RequestMapping(value="find")
	public View Com0070FindView(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Com0070ParamVO param = new Com0070ParamVO();
			...
			// 서비스CALL
			List<Com0070> list = service.find(param);  
