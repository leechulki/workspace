...
import hdel.sd.sbp.service.Sbp0100S;
...
@Controller
@RequestMapping("sbp0100")
public class Sbp0100C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			List<Sbp0100VO> list = service.find(paramV);
		
			// list결과를 dataset으로 담기
			Dataset dsOutput = new Dataset();
			SmpComC.moveDs2List(dsOutput, Sbp0100VO.class, list );
