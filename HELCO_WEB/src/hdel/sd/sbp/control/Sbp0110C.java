...
import hdel.sd.sbp.service.Sbp0110S;
...
@Controller
@RequestMapping("sbp0110")
public class Sbp0110C extends CallSAP{
	...
	public View find(MipParameterVO paramVO, Model model) {
		...
		try { 
			...
			Sbp0110ParamVO paramV = new Sbp0110ParamVO();					// vo
			...
			List<Sbp0110VO> list = service.find(paramV);
			
			// list결과를 dataset으로 담기
			Dataset dsOutput = new Dataset();
			SmpComC.moveDs2List(dsOutput, Sbp0110VO.class, list );
