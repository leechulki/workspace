 ...
 * HISTORY  : 신규개발
 */
public class Sbp0090VO extends ParameterVO {
	...
	private String ZPYM_DETAIL;		// 매출년월, 청구년월, 수금년월
	private String LAND1;			// 국가
	private String ZBDTYP;			// 건물용도 jss
	private String ZBDTYP_LNM;		// 건물용도대분류 jss
	...
	public String getZPYM_DETAIL() {
		return ZPYM_DETAIL;
	}
	public void setZPYM_DETAIL(String zPYM_DETAIL) {
		ZPYM_DETAIL = zPYM_DETAIL;
	}
