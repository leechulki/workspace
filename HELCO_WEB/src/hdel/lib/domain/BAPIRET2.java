...
public class BAPIRET2  implements java.io.Serializable {
	...
	public static Dataset getDataset() {
		...
		ds.addColumn("TYPE", ColumnInfo.COLUMN_TYPE_STRING, 1);
		ds.addColumn("ID", ColumnInfo.COLUMN_TYPE_STRING, 20);
		ds.addColumn("NUMBER", ColumnInfo.COLUMN_TYPE_STRING, 3);
		ds.addColumn("MESSAGE", ColumnInfo.COLUMN_TYPE_STRING, 220);
		ds.addColumn("LOG_NO", ColumnInfo.COLUMN_TYPE_STRING, 20);
		ds.addColumn("LOG_MSG_NO", ColumnInfo.COLUMN_TYPE_STRING, 6);
		ds.addColumn("MESSAGE_V1", ColumnInfo.COLUMN_TYPE_STRING, 50);
		ds.addColumn("MESSAGE_V2", ColumnInfo.COLUMN_TYPE_STRING, 50);
		ds.addColumn("MESSAGE_V3", ColumnInfo.COLUMN_TYPE_STRING, 50);
		ds.addColumn("MESSAGE_V4", ColumnInfo.COLUMN_TYPE_STRING, 50);
		ds.addColumn("PARAMETER", ColumnInfo.COLUMN_TYPE_STRING, 32);
		ds.addColumn("ROW", ColumnInfo.COLUMN_TYPE_INT, 10);
	    ds.addColumn("FIELD", ColumnInfo.COLUMN_TYPE_STRING, 30);
	    ds.addColumn("SYSTEM", ColumnInfo.COLUMN_TYPE_STRING, 10);
	    return ds;
	}
}
