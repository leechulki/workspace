...
public class TransForCOLLESEVAL
{
    ...
    * 기  타 :
    */
   public int ProcTransForCOLLESEVAL (String mandt,String scrGubun, Connection conn) throws SQLException, Exception
   {
       SqlExecutor db = null;
     ...
     years = YYYYMMDD0.substring(0,4);
      ...
      master.addParamObject("CHK_GBN", "11");
      master.addParamObject("CHK_GBN2", "02");
      ...
      if(returnDs.getRowCount() != 0){
          System.out.println("==============================================================================");
    	  System.out.println("협력사평가 협력도평가 협력사별 처리 BATCH(ES)는 반기에 한번 실행됩니다.협력사평가 협력도평가 협력사별처리 BATCH가 이미 실행되었습니다.");
          System.out.println("==============================================================================\n");
    	  //return 0;
      }
...
//      LoggablePreparedStatement  pstmt1    = null;
     ...
     sqlBuff.append("  ,  '11'    --설치구분 CHAR    1   NOT NULL    PK \n");
...
//          sqlBuff.append("    AND LIFNO = ?       \n"); 
   ...
   public TransForCOLLESEVAL(Logger pLogger)
   {
      logger = pLogger;
   }
}