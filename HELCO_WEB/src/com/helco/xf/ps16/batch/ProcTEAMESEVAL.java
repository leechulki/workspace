/**
 * 파 일 명 : ProcTEAMEVAL.java
 * 설    명 : 협력사평가 협력도평가 반기별 팀장별 BATCH 처리(ES)
...
public class ProcTEAMESEVAL extends AbstractBusinessService implements ScheduleTask
{
   ...
   public void run() throws Exception {
     ...
     // Connection conn_hep = null;
      ...
      System.out.println("==============================================================================");
      System.out.println("협력사평가 협력도평가 반기별 팀장별 BATCH(ES) 프로세스 START : " + CommonUtil.getToday() + "  " + CommonUtil.getCurrentTimeHHMMSS());
      System.out.println("==============================================================================\n");

      TransForTEAMESEVAL emTran = new TransForTEAMESEVAL(logger);
	 ...
	 //    conn_hep = getConnection(db_con_hep);
      ...
      //   conn_hep.setAutoCommit(true);
         System.out.println("ProcTransForCOLLTEAMESEVAL(ES) start!!");
         int ret2 =   emTran.ProcTransForCOLLTEAMESEVAL(mandt, "2", conn);
         System.out.println("ProcTransForCOLLTEAMESEVAL(ES) END  !! [" + ret2);
         conn.commit();
      //   conn_hep.commit();
      ...
      System.out.println("==============================================================================");
      System.out.println("협력사평가 협력도평가 팀장별 BATCH(ES) 프로세스 END : " + CommonUtil.getToday() + "  " + CommonUtil.getCurrentTimeHHMMSS());
      System.out.println("==============================================================================\n");
   }
