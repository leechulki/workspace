 ...
 * 설    명 : 협력사평가 협력도평가 협력사별 처리 BATCH(ES)
...
public class ProcCOLLESEVAL extends AbstractBusinessService implements ScheduleTask
{
   ...
   public void run() throws Exception {
    ...
    //  Connection conn_hep = null;
      ...
      System.out.println("==============================================================================");
      System.out.println("협력사평가 협력도평가 반기별 협력사별 BATCH(ES) 프로세스 START : " + CommonUtil.getToday() + "  " + CommonUtil.getCurrentTimeHHMMSS());
      System.out.println("==============================================================================\n");

      TransForCOLLESEVAL emTran = new TransForCOLLESEVAL(logger);
      ...
      //   conn_hep.setAutoCommit(true);
         System.out.println("ProcTransForCOLLESEVAL start!!");
         int ret1 =   emTran.ProcTransForCOLLESEVAL(mandt,"1", conn);
         System.out.println("ProcTransForCOLLESEVAL END  !! [" + ret1);
         conn.commit();
       //  conn_hep.commit();
      ...
      System.out.println("==============================================================================");
      System.out.println("협력사평가 협력도평가 협력사별 BATCH(ES) 프로세스 END : " + CommonUtil.getToday() + "  " + CommonUtil.getCurrentTimeHHMMSS());
      System.out.println("==============================================================================\n");
   }
