 ...
 * 설    명 : 협력사평가 협력도평가 반기별 팀장별 BATCH 처리
...
public class ProcTEAMEVAL extends AbstractBusinessService implements ScheduleTask
{
   ...
   public void run() throws Exception {
    ...
    //  Connection conn_hep = null;
      ...
      System.out.println("==============================================================================");
      System.out.println("협력사평가 협력도평가 반기별 팀장별 BATCH 프로세스 START : " + CommonUtil.getToday() + "  " + CommonUtil.getCurrentTimeHHMMSS());
      System.out.println("==============================================================================\n");
     ...
     //    conn_hep.setAutoCommit(true);
      ...
      System.out.println("==============================================================================");
      System.out.println("협력사평가 협력도평가 팀장별 BATCH 프로세스 END : " + CommonUtil.getToday() + "  " + CommonUtil.getCurrentTimeHHMMSS());
      System.out.println("==============================================================================\n");
   }
