...
public class PP0102019A_ACT extends AbstractAction {
	public static final String ZWEB_PP_GET_ZPPR091 
	= "com.helco.xf.pp01.ws.ZWEB_PP_GET_ZPPR091";
...
public void query(BusinessContext ctx) throws Exception {
	...
	// 호출 
	SapFunction stub = CallSAP.callSap(ctx.getInputVariable("G_MANDT"), ZWEB_PP_GET_ZPPR091, obj);
	
	// 출력 Dataset 생성 
	Dataset ds = CallSAP.isJCO() ? new Dataset() : ZPPS091.getDataset();
	ds.setId("ds_list");
