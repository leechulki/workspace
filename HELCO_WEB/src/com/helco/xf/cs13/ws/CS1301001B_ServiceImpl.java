...
public class CS1301001B_ServiceImpl extends AbstractBusinessService implements
		CS1301001B_Service {
	...
	public void delete(String empno) throws Exception {
		SqlRequest sqlRequest 
			= SqlMapManagerUtility.makeSqlRequest("test3:EMP_DELETE");
	...
	public void update(Dataset ds) throws Exception {
		DatasetSqlRequest sqlRequest 
			= SqlMapManagerUtility.makeSqlRequestForDataset("test3:EMP_UPDATE");
		sqlRequest.addParamObject("ds_master", ds);
