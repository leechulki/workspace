...
public class MM0502001A_ACT extends AbstractAction {

	public static final String ZWEB_LE_GET_DN001
		= "com.helco.xf.mm05.ws.ZWEB_LE_GET_DN001";
	...
	public void query(BusinessContext ctx) throws Exception {
		...
		// 호출 
		//SapFunction stub 
		//		= CallSAP.callSap(ctx.getInputVariable("G_MANDT"), ZWEB_LE_GET_DN001, obj);
		
		// eai 도입으로 인해 변경
		SapFunction stub = CallSAP.callSap(ctx.getInputVariable("G_SYSID"), ctx.getInputVariable("G_MANDT"), ZWEB_LE_GET_DN001, obj, false);
		...
		for(int i=0; i<ds2.getRowCount(); i++){
			if( ds2.getColumnAsString(i,"ZSTAT4").equals("3") || 
