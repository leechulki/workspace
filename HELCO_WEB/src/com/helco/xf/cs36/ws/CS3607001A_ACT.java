...
public class CS3607001A_ACT extends AbstractAction {
	...
	public void query(BusinessContext ctx) throws Exception {
		...
		SapFunction stub = CallSAP.callSap(ctx.getInputVariable("G_SYSID"), ctx.getInputVariable("G_MANDT"), ZWEB_CS_DGNO, obj, false);		 // 기존  SAP 연결
		//SapFunction stub = CallSAP.callSapEai(ctx.getInputVariable("G_SYSID"), ctx.getInputVariable("G_MANDT"), ZWEB_CS_DGNO, obj, false);  // EAI 연결
