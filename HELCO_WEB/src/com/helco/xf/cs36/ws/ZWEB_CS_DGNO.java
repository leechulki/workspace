...
public class ZWEB_CS_DGNO extends WebServiceStub {

	public ZWEB_CS_DGNO() throws AxisFault {
		super();
	}
	...
	protected void initOperation(Object obj) {
    	...
    	oper.addParameter(makeArrayParam("O_TAB", PARAM_INOUT, "TABLE_OF_ZCSS009", ZCSS009[].class, "item" ));
	}
}
