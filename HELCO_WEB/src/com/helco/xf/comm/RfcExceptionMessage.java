...
/**
 * RFC °øÅë Exception Message 
 */
public class RfcExceptionMessage implements Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sap-com:document:sap:rfc:functions", "RfcException.Message"));
