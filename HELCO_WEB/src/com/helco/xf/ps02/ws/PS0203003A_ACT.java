...
public class PS0203003A_ACT extends AbstractAction {
	...
	public void query(BusinessContext ctx) throws Exception {
		...
		// SAP Call 
		stub = CallSAP.callSap(ctx.getInputVariable("G_SYSID"),ctx.getInputVariable("G_MANDT"),"com.helco.xf.ps02.ws.ZWEB_PS_GET_0008", obj,false);
		// Dataset make
