...
public class PS0203002A_ACT extends AbstractAction {

	public void query(BusinessContext ctx) throws Exception {
		Dataset dsCond = ctx.getInputDataset("ds_cond");
		SapFunction stub = null;
		Dataset dsList = null;
		ZPSS012[] list = new ZPSS012[]{};
		...
		// SAP Call 
		stub = CallSAP.callSap(ctx.getInputVariable("G_SYSID"),ctx.getInputVariable("G_MANDT"),"com.helco.xf.ps02.ws.ZWEB_PS_GET_0007", obj,false);
		// Dataset make
		dsList = CallSAP.isJCO() ? new Dataset() : ZPSS012.getDataset();
	...
	public void save(BusinessContext ctx) throws Exception {
		...
		if (CallSAP.isJCO()) {
			...
			SapFunction stub = CallSAP.callSap(ctx.getInputVariable("G_SYSID"),ctx.getInputVariable("G_MANDT"),"com.helco.xf.ps02.ws.ZWEB_PS_SET_0003", new Object[]{dsList},false);
			...
			// 저장 처리 
			SapFunction stub = CallSAP.callSap(ctx.getInputVariable("G_SYSID"),ctx.getInputVariable("G_MANDT"),"com.helco.xf.ps02.ws.ZWEB_PS_SET_0003", new Object[]{msgList, list},false);
	 ...
	 * @throws Exception
	 */
	public void save1(BusinessContext ctx) throws Exception {
		Dataset dsList = ctx.getInputDataset("ds_list");
		Dataset dsError = null; //CallSAP.makeErrorInfo( msgList );
